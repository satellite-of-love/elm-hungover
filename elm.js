...
Elm.FirstProject = Elm.FirstProject || {};
Elm.FirstProject.make = function (_elm) {
   "use strict";
   _elm.FirstProject = _elm.FirstProject || {};
   if (_elm.FirstProject.values)
   return _elm.FirstProject.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var main = $Html.text("hello friends");
   _elm.FirstProject.values = {_op: _op
                              ,main: main};
   return _elm.FirstProject.values;
};
